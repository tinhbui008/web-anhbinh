...
//            add_filter("manage_media_columns", [$this, "wpdiscuzMediaCommentColumn"], 10, 2);
    ...
    public function uploadButtons($html, $uniqueId)
    {
        if ($this->isUploadingAllowed()) {
            ...
            $html .= "<input style='display:none;' class='wmu-add-files' multiple type='file' name='" . self::INPUT_NAME . "' $type $allowedExts/>";
            $html .= "</label>";
            $html .= "</span>";
        }
        return $html;
    ...
    public function checkFiles()
    {
        ...
        $allowedCount = apply_filters("wpdiscuz_mu_file_count", 9999);
